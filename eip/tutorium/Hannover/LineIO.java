 ...
 *           Methoden der 2. Auflage des Rauh- Buches endgültig entfernt
 ...
 * 04.09.02  Hinzufuegen von write/writeln fuer char, boolean, Object
...
//-- Ausgabe-Methoden -------------------------------------------
   ...
   */
    public void write(double value, int noChar, int noFrac) {
      ...
      if(Math.abs(value)<1.0E-3) { // bei sehr kleinen werten wird tempor�r
