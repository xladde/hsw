...
package de.ejb3buch.ticket2rock.session.admin;
...
public class AdminBean implements Admin {
	...
	static Logger logger = Logger.getLogger(AdminBean.class);
	...
	public void onPostConstruct() /* throws Exception */{
		...
		env.put(Context.PROVIDER_URL, "ldap:///o=ldap,dc=ticket2rock,dc=de");
